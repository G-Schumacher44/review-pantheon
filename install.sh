...
# if this repo re-pins to a newer review-pantheon release; a hand-edited copy is left alone on
# rerun (install.sh's cmp-and-skip idempotency treats it as customized).
#
