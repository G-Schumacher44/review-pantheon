...
# cli/providers/*.sh, agents/*.md) so review-gate's own PANTHEON_ROOT-relative path
# resolution (agents/ and cli/providers/ next to it) works unmodified from the prefix, exactly
# as it does from an in-repo checkout.
# ---------------------------------------------------------------------------
SKIPPED=()
