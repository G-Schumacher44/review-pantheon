...
tests/                     17 fixture-test scripts (13 one-per-seam, plus four Python-port
                           black-box equivalents docs/PYTHON-PORT.md's Slices 2 and 3 added — see
                           that doc's section 4) — CONTRIBUTING.md's dev-setup table is the
